...
##Instructions for Collaborators to Connect
...
Login using your mongoAtlas Id then change copy the standard string and paste here replace **password with your password** and **test with mainDB**.
