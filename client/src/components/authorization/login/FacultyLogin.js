...
import { facultyLogin } from '../../../actions/authActions'
...
class FacultyLogin extends Component{
  ...
  onSubmit(e) {
    ...
    this.props.facultyLogin(userData);
  }
  render () {
...
FacultyLogin.propTypes = {
  facultyLogin:PropTypes.func.isRequired,
...
export default connect(mapStateToProps,{facultyLogin})(FacultyLogin);